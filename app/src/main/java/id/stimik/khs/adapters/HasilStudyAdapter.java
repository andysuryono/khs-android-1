...
public class HasilStudyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HasilStudyAdapter(Context ctx) {
        this.ctx = ctx;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_hasil_study, parent, false);
