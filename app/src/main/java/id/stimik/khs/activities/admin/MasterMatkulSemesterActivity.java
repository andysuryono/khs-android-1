...
public class MasterMatkulSemesterActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        adapter.setOnItemClickListener(new SemesterAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                Intent intent = new Intent(MasterMatkulSemesterActivity.this, MasterMatkulActivity.class);
